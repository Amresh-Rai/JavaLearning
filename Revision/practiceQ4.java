...
public class practiceQ4 {
    ...
    static void reverseRowOrder(int[][]matrix){
        int s=0;
        int e=matrix.length-1;
        while(s<e){
            int[]temp=matrix[s];
    ...
    static void Rotate180Degree(int [][]matrix,int n){
 ...
 public static void main(String[] args) {
        ...
        System.out.println("the matrix after the 180 degree rotation :");
        Rotate180Degree(matrix, r);
        print(matrix);
